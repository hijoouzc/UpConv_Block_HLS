set moduleName upconv_core_top_ucb0_Pipeline_LOAD_ROW_VITIS_LOOP_308_2
set isTopModule 0
...
set cdfgNum 16
set C_modelName {upconv_core_top_ucb0_Pipeline_LOAD_ROW_VITIS_LOOP_308_2}
...
set C_modelArgList {
	...
	{ empty int 5 regular  }
	{ sext_ln305 int 59 regular  }
	{ zext_ln306 int 14 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_in", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "X","offset": { "type": "dynamic","port_name": "X","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "sext_ln305", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln306", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln305 sc_in sc_lv 59 signal 2 } 
	{ zext_ln306 sc_in sc_lv 14 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln305", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "sext_ln305", "role": "default" }} , 
 	{ "name": "zext_ln306", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "zext_ln306", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln305 { ap_none {  { sext_ln305 in_data 0 59 } } }
	zext_ln306 { ap_none {  { zext_ln306 in_data 0 14 } } }
