set moduleName upconv_core_top_ucb0_Pipeline_LOAD_ROW0_VITIS_LOOP_386_1
set isTopModule 0
...
set cdfgNum 15
set C_modelName {upconv_core_top_ucb0_Pipeline_LOAD_ROW0_VITIS_LOOP_386_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_in", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "X","offset": { "type": "dynamic","port_name": "X","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln385", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln385 sc_in sc_lv 59 signal 1 } 
	{ x_buf_address0 sc_out sc_lv 11 signal 2 } 
	{ x_buf_ce0 sc_out sc_logic 1 signal 2 } 
	{ x_buf_we0 sc_out sc_logic 1 signal 2 } 
	{ x_buf_d0 sc_out sc_lv 256 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln385", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "sext_ln385", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln385 { ap_none {  { sext_ln385 in_data 0 59 } } }
