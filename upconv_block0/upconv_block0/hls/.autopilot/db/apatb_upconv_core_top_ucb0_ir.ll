; ModuleID = '/home/hoinguyen/Documents/Vitis/UpConv_HLS/upconv_block0/upconv_block0/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_upconv_core_top_ucb0_ir(%"struct.ap_uint<256>"* noalias nocapture nonnull readonly "maxi" %X, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly "maxi" %W, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly "maxi" %B, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly "maxi" %G, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly "maxi" %BE, %"struct.ap_uint<256>"* noalias nocapture nonnull "maxi" %Y, half* nocapture readonly %epsilon) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_upconv_core_top_ucb0_hw(i256* %X_copy, i256* %W_copy, i256* %B_copy, i256* %G_copy, i256* %BE_copy, i256* %Y_copy, half* %epsilon)
...
declare void @apatb_upconv_core_top_ucb0_hw(i256*, i256*, i256*, i256*, i256*, i256*, half*)
...
declare void @upconv_core_top_ucb0_hw_stub(%"struct.ap_uint<256>"* noalias nocapture nonnull readonly, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly, %"struct.ap_uint<256>"* noalias nocapture nonnull, half* nocapture readonly)

define void @upconv_core_top_ucb0_hw_stub_wrapper(i256*, i256*, i256*, i256*, i256*, i256*, half*) #4 {
entry:
  ...
  call void @upconv_core_top_ucb0_hw_stub(%"struct.ap_uint<256>"* %8, %"struct.ap_uint<256>"* %10, %"struct.ap_uint<256>"* %12, %"struct.ap_uint<256>"* %14, %"struct.ap_uint<256>"* %16, %"struct.ap_uint<256>"* %18, half* %6)
