...
module upconv_core_top_ucb1_upconv_core_top_ucb1_Pipeline_LOAD_ROW0_VITIS_LOOP_296_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire    ap_loop_init;
reg   [5:0] wi_fu_78;
wire   [5:0] select_ln295_1_fu_181_p3;
...
assign add_ln295_fu_161_p2 = (wi_fu_78 + 6'd1);

assign add_ln296_fu_229_p2 = (select_ln295_fu_173_p3 + 5'd1);
...
assign select_ln295_fu_173_p3 = ((icmp_ln296_fu_167_p2[0:0] == 1'b1) ? 5'd0 : ciw_fu_74);

assign sub_ln296_fu_213_p2 = (p_shl_fu_193_p3 - zext_ln296_fu_209_p1);

assign tmp_fu_201_p3 = {{select_ln295_1_fu_181_p3}, {1'd0}};

assign trunc_ln296_fu_189_p1 = select_ln295_1_fu_181_p3[4:0];
...
endmodule //upconv_core_top_ucb1_upconv_core_top_ucb1_Pipeline_LOAD_ROW0_VITIS_LOOP_296_1
