set moduleName upconv_core_top_ucb1_Pipeline_LOAD_ROW_VITIS_LOOP_397_2
set isTopModule 0
...
set cdfgNum 15
set C_modelName {upconv_core_top_ucb1_Pipeline_LOAD_ROW_VITIS_LOOP_397_2}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_in", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "X","offset": { "type": "dynamic","port_name": "X","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "mul_ln395", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ mul_ln395 sc_in sc_lv 15 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mul_ln395", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "mul_ln395", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	mul_ln395 { ap_none {  { mul_ln395 in_data 0 15 } } }
