set moduleName UpConv_Fused_Row_8_32_32_480_240_Pipeline_LOAD_G
set isTopModule 0
...
set cdfgNum 15
set C_modelName {UpConv_Fused_Row<8, 32, 32, 480, 240>_Pipeline_LOAD_G}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict g_buf { MEM_WIDTH 256 MEM_SIZE 480 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem_param int 256 regular {axi_master 0}  }
	{ sext_ln189 int 59 regular  }
	{ g_buf int 256 regular {array 15 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_param", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "B","offset": { "type": "dynamic","port_name": "B","bundle": "control"},"direction": "READONLY"},{"cName": "G","offset": { "type": "dynamic","port_name": "G","bundle": "control"},"direction": "READONLY"},{"cName": "BE","offset": { "type": "dynamic","port_name": "BE","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln189", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln189 sc_in sc_lv 59 signal 1 } 
	{ g_buf_address0 sc_out sc_lv 4 signal 2 } 
	{ g_buf_ce0 sc_out sc_logic 1 signal 2 } 
	{ g_buf_we0 sc_out sc_logic 1 signal 2 } 
	{ g_buf_d0 sc_out sc_lv 256 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln189", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "sext_ln189", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln189 { ap_none {  { sext_ln189 in_data 0 59 } } }
	g_buf { ap_memory {  { g_buf_address0 mem_address 1 4 }  { g_buf_ce0 mem_ce 1 1 }  { g_buf_we0 mem_we 1 1 }  { g_buf_d0 mem_din 1 256 } } }
}
