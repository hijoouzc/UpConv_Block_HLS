set moduleName upconv_core_top_ucb1_Pipeline_LOAD_ROW_VITIS_LOOP_307_2
set isTopModule 0
...
set cdfgNum 13
set C_modelName {upconv_core_top_ucb1_Pipeline_LOAD_ROW_VITIS_LOOP_307_2}
...
set C_modelArgList {
	...
	{ empty int 6 regular  }
	{ mul_ln305 int 15 regular  }
	{ sext_ln304 int 59 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_in", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "X","offset": { "type": "dynamic","port_name": "X","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "mul_ln305", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln304", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ mul_ln305 sc_in sc_lv 15 signal 2 } 
	{ sext_ln304 sc_in sc_lv 59 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mul_ln305", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "mul_ln305", "role": "default" }} , 
 	{ "name": "sext_ln304", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "sext_ln304", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	mul_ln305 { ap_none {  { mul_ln305 in_data 0 15 } } }
	sext_ln304 { ap_none {  { sext_ln304 in_data 0 59 } } }
