...
set name upconv_core_top_ucb1_hsub_16ns_16ns_16_5_full_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {hsub} IMPL {fulldsp} LATENCY 4 ALLOW_PRAGMA 1
}


set name upconv_core_top_ucb1_hcmp_16ns_16ns_1_2_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename mean_buf \
    op interface \
    ports { mean_buf_address0 { O 6 vector } mean_buf_ce0 { O 1 bit } mean_buf_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename inv_buf \
    op interface \
    ports { inv_buf_address0 { O 6 vector } inv_buf_ce0 { O 1 bit } inv_buf_q0 { I 16 vector } } \
} "
} else {
