...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler upconv_core_top_ucb1_partselect_16ns_256ns_32s_16_1_1 BINDTYPE {op} TYPE {partselect} IMPL {auto}
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler upconv_core_top_ucb1_sparsemux_17_3_32_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {compactencoding_dontcare}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename mean_buf \
    op interface \
    ports { mean_buf_address1 { O 6 vector } mean_buf_ce1 { O 1 bit } mean_buf_we1 { O 1 bit } mean_buf_d1 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename inv_buf \
    op interface \
    ports { inv_buf_address1 { O 6 vector } inv_buf_ce1 { O 1 bit } inv_buf_we1 { O 1 bit } inv_buf_d1 { O 16 vector } } \
} "
} else {
