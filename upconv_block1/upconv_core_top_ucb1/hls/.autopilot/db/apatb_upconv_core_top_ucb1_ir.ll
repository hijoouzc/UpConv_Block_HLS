; ModuleID = '/home/hoinguyen/Documents/Vitis/UpConv_HLS/upconv_block1/upconv_core_top_ucb1/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_upconv_core_top_ucb1_ir(%"struct.ap_uint<256>"* noalias nocapture nonnull readonly "maxi" %X, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly "maxi" %W, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly "maxi" %B, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly "maxi" %G, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly "maxi" %BE, %"struct.ap_uint<256>"* noalias nocapture nonnull "maxi" %Y, half* nocapture readonly %epsilon) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_upconv_core_top_ucb1_hw(i256* %X_copy, i256* %W_copy, i256* %B_copy, i256* %G_copy, i256* %BE_copy, i256* %Y_copy, half* %epsilon)
...
entry:
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<256>.18"(i256* align 512 %1, %"struct.ap_uint<256>"* %0)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<256>.18"(i256* align 512 %3, %"struct.ap_uint<256>"* %2)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<256>.18"(i256* align 512 %5, %"struct.ap_uint<256>"* %4)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<256>.18"(i256* align 512 %7, %"struct.ap_uint<256>"* %6)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<256>.18"(i256* align 512 %9, %"struct.ap_uint<256>"* %8)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<256>.18"(i256* align 512 %11, %"struct.ap_uint<256>"* %10)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_uint<256>.18"(i256* noalias nocapture align 512 "unpacked"="0.0" %dst, %"struct.ap_uint<256>"* noalias readonly "unpacked"="1" %src) unnamed_addr #3 {
entry:
...
declare void @apatb_upconv_core_top_ucb1_hw(i256*, i256*, i256*, i256*, i256*, i256*, half*)
...
declare void @upconv_core_top_ucb1_hw_stub(%"struct.ap_uint<256>"* noalias nocapture nonnull readonly, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly, %"struct.ap_uint<256>"* noalias nocapture nonnull, half* nocapture readonly)

define void @upconv_core_top_ucb1_hw_stub_wrapper(i256*, i256*, i256*, i256*, i256*, i256*, half*) #4 {
entry:
  %7 = call i8* @malloc(i64 32)
  %8 = bitcast i8* %7 to %"struct.ap_uint<256>"*
  %9 = call i8* @malloc(i64 32)
  %10 = bitcast i8* %9 to %"struct.ap_uint<256>"*
  %11 = call i8* @malloc(i64 32)
  %12 = bitcast i8* %11 to %"struct.ap_uint<256>"*
  %13 = call i8* @malloc(i64 32)
  %14 = bitcast i8* %13 to %"struct.ap_uint<256>"*
  %15 = call i8* @malloc(i64 32)
  %16 = bitcast i8* %15 to %"struct.ap_uint<256>"*
  %17 = call i8* @malloc(i64 32)
  %18 = bitcast i8* %17 to %"struct.ap_uint<256>"*
  call void @copy_out(%"struct.ap_uint<256>"* %8, i256* %0, %"struct.ap_uint<256>"* %10, i256* %1, %"struct.ap_uint<256>"* %12, i256* %2, %"struct.ap_uint<256>"* %14, i256* %3, %"struct.ap_uint<256>"* %16, i256* %4, %"struct.ap_uint<256>"* %18, i256* %5)
  call void @upconv_core_top_ucb1_hw_stub(%"struct.ap_uint<256>"* %8, %"struct.ap_uint<256>"* %10, %"struct.ap_uint<256>"* %12, %"struct.ap_uint<256>"* %14, %"struct.ap_uint<256>"* %16, %"struct.ap_uint<256>"* %18, half* %6)
  call void @copy_in(%"struct.ap_uint<256>"* %8, i256* %0, %"struct.ap_uint<256>"* %10, i256* %1, %"struct.ap_uint<256>"* %12, i256* %2, %"struct.ap_uint<256>"* %14, i256* %3, %"struct.ap_uint<256>"* %16, i256* %4, %"struct.ap_uint<256>"* %18, i256* %5)
  call void @free(i8* %7)
  call void @free(i8* %9)
