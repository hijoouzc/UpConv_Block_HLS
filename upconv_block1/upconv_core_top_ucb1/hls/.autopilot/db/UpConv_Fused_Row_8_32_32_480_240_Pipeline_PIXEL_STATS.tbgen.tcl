...
dict set ap_memory_interface_dict mean_buf { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict inv_buf { MEM_WIDTH 16 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
...
set C_modelArgList {
	...
	{ mean_buf float 32 regular {array 64 { 3 0 } 0 1 } {global 1}  }
	{ inv_buf int 16 regular {array 64 { 3 0 } 0 1 } {global 1}  }
...
set portList { 
	...
	{ grp_fu_405_p_din0 sc_out sc_lv 16 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mean_buf_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "mean_buf", "role": "address1" }} , 
 	...
 	{ "name": "inv_buf_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "inv_buf", "role": "address1" }} , 
 	...
 	{ "name": "grp_fu_405_p_din0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "grp_fu_405_p_din0", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	mean_buf { ap_memory {  { mean_buf_address1 MemPortADDR2 1 6 }  { mean_buf_ce1 MemPortCE2 1 1 }  { mean_buf_we1 MemPortWE2 1 1 }  { mean_buf_d1 MemPortDIN2 1 32 } } }
	inv_buf { ap_memory {  { inv_buf_address1 MemPortADDR2 1 6 }  { inv_buf_ce1 MemPortCE2 1 1 }  { inv_buf_we1 MemPortWE2 1 1 }  { inv_buf_d1 MemPortDIN2 1 16 } } }
