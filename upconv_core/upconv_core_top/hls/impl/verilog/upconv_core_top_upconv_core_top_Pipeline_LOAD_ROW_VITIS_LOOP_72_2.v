...
wire   [10:0] ci_words_cast_cast_fu_142_p1;
reg   [10:0] ci_words_cast_cast_reg_286;
...
upconv_core_top_ama_addmuladd_8ns_8ns_6ns_6ns_11_4_1 #(
    ...
    .din3_WIDTH( 6 ),
    .dout_WIDTH( 11 ))
ama_addmuladd_8ns_8ns_6ns_6ns_11_4_1_U719(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ci_words_cast_cast_reg_286[5 : 0] <= ci_words_cast_cast_fu_142_p1[5 : 0];
...
assign ci_words_cast_cast_fu_142_p1 = ci_words_cast;

assign grp_fu_247_p2 = ci_words_cast_cast_reg_286;
...
always @ (posedge ap_clk) begin
    ci_words_cast_cast_reg_286[10:6] <= 5'b00000;
end
