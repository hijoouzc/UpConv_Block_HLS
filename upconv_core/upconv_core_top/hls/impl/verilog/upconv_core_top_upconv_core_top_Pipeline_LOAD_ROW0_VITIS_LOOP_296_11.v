...
module upconv_core_top_upconv_core_top_Pipeline_LOAD_ROW0_VITIS_LOOP_296_11 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [9:0] add_ln298_fu_223_p2;
reg   [9:0] add_ln298_reg_279;
wire    ap_block_pp0_stage0_11001_grp0;
reg    ap_block_pp0_stage0_subdone_grp0_done_reg;
wire    ap_block_pp0_stage0_subdone_grp0;
reg   [255:0] gmem_in_addr_read_reg_284;
wire   [63:0] zext_ln298_fu_245_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [4:0] ciw_fu_74;
wire   [4:0] add_ln296_fu_229_p2;
wire    ap_loop_init;
reg   [5:0] wi_2_fu_78;
wire   [5:0] select_ln295_fu_181_p3;
reg   [9:0] indvar_flatten13_fu_82;
wire   [9:0] add_ln295_fu_138_p2;
reg   [9:0] ap_sig_allocacmp_indvar_flatten13_load;
wire    ap_block_pp0_stage0;
reg    x_buf_we0_local;
reg    x_buf_ce0_local;
wire   [0:0] icmp_ln296_fu_167_p2;
wire   [5:0] add_ln295_2_fu_161_p2;
wire   [4:0] trunc_ln296_fu_189_p1;
wire   [6:0] tmp_fu_201_p3;
wire   [9:0] p_shl_fu_193_p3;
wire   [9:0] zext_ln296_fu_209_p1;
wire   [4:0] select_ln295_2_fu_173_p3;
wire   [9:0] zext_ln296_2_fu_219_p1;
wire   [9:0] sub_ln296_fu_213_p2;
reg    ap_done_reg;
...
#0 ciw_fu_74 = 5'd0;
#0 wi_2_fu_78 = 6'd0;
#0 indvar_flatten13_fu_82 = 10'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln295_fu_132_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten13_fu_82 <= add_ln295_fu_138_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten13_fu_82 <= 10'd0;
        end
    end
end
...
always @ (*) begin
    if (((icmp_ln295_fu_132_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln295_2_fu_161_p2 = (wi_2_fu_78 + 6'd1);

assign add_ln295_fu_138_p2 = (ap_sig_allocacmp_indvar_flatten13_load + 10'd1);

assign add_ln296_fu_229_p2 = (select_ln295_2_fu_173_p3 + 5'd1);

assign add_ln298_fu_223_p2 = (zext_ln296_2_fu_219_p1 + sub_ln296_fu_213_p2);
...
assign icmp_ln295_fu_132_p2 = ((ap_sig_allocacmp_indvar_flatten13_load == 10'd960) ? 1'b1 : 1'b0);

assign icmp_ln296_fu_167_p2 = ((ciw_fu_74 == 5'd30) ? 1'b1 : 1'b0);
...
assign p_shl_fu_193_p3 = {{trunc_ln296_fu_189_p1}, {5'd0}};

assign select_ln295_2_fu_173_p3 = ((icmp_ln296_fu_167_p2[0:0] == 1'b1) ? 5'd0 : ciw_fu_74);

assign select_ln295_fu_181_p3 = ((icmp_ln296_fu_167_p2[0:0] == 1'b1) ? add_ln295_2_fu_161_p2 : wi_2_fu_78);

assign sub_ln296_fu_213_p2 = (p_shl_fu_193_p3 - zext_ln296_fu_209_p1);

assign tmp_fu_201_p3 = {{select_ln295_fu_181_p3}, {1'd0}};

assign trunc_ln296_fu_189_p1 = select_ln295_fu_181_p3[4:0];

assign x_buf_address0 = zext_ln298_fu_245_p1;

assign x_buf_ce0 = x_buf_ce0_local;

assign x_buf_d0 = gmem_in_addr_read_reg_284;

assign x_buf_we0 = x_buf_we0_local;

assign zext_ln296_2_fu_219_p1 = select_ln295_2_fu_173_p3;

assign zext_ln296_fu_209_p1 = tmp_fu_201_p3;

assign zext_ln298_fu_245_p1 = add_ln298_reg_279;

endmodule //upconv_core_top_upconv_core_top_Pipeline_LOAD_ROW0_VITIS_LOOP_296_11
