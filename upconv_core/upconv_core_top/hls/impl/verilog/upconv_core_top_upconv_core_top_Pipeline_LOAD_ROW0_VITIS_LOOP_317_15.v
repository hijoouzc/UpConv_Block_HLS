...
module upconv_core_top_upconv_core_top_Pipeline_LOAD_ROW0_VITIS_LOOP_317_15 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign add_ln316_1_fu_159_p2 = (wi_fu_76 + 8'd1);

assign add_ln316_fu_136_p2 = (ap_sig_allocacmp_indvar_flatten41_load + 11'd1);

assign add_ln317_fu_209_p2 = (select_ln316_fu_171_p3 + 4'd1);

assign add_ln319_fu_203_p2 = (zext_ln317_fu_199_p1 + tmp_1_fu_191_p3);
...
assign icmp_ln316_fu_130_p2 = ((ap_sig_allocacmp_indvar_flatten41_load == 11'd1024) ? 1'b1 : 1'b0);
...
assign select_ln316_1_fu_179_p3 = ((icmp_ln317_fu_165_p2[0:0] == 1'b1) ? add_ln316_1_fu_159_p2 : wi_fu_76);
...
endmodule //upconv_core_top_upconv_core_top_Pipeline_LOAD_ROW0_VITIS_LOOP_317_15
