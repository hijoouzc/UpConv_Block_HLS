...
module upconv_core_top_upconv_core_top_Pipeline_LOAD_ROW0_VITIS_LOOP_296_15 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [9:0] add_ln298_fu_203_p2;
reg   [9:0] add_ln298_reg_259;
wire    ap_block_pp0_stage0_11001_grp0;
reg    ap_block_pp0_stage0_subdone_grp0_done_reg;
wire    ap_block_pp0_stage0_subdone_grp0;
reg   [255:0] gmem_in_addr_read_reg_264;
wire   [63:0] zext_ln298_fu_225_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [3:0] ciw_fu_72;
wire   [3:0] add_ln296_fu_209_p2;
wire    ap_loop_init;
reg   [7:0] wi_fu_76;
wire   [7:0] select_ln295_1_fu_179_p3;
reg   [10:0] indvar_flatten41_fu_80;
wire   [10:0] add_ln295_fu_136_p2;
reg   [10:0] ap_sig_allocacmp_indvar_flatten41_load;
wire    ap_block_pp0_stage0;
reg    x_buf_we0_local;
reg    x_buf_ce0_local;
wire   [0:0] icmp_ln296_fu_165_p2;
wire   [7:0] add_ln295_1_fu_159_p2;
wire   [6:0] empty_fu_187_p1;
wire   [3:0] select_ln295_fu_171_p3;
wire   [9:0] zext_ln296_fu_199_p1;
wire   [9:0] tmp_1_fu_191_p3;
reg    ap_done_reg;
...
#0 ciw_fu_72 = 4'd0;
#0 wi_fu_76 = 8'd0;
#0 indvar_flatten41_fu_80 = 11'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln295_fu_130_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten41_fu_80 <= add_ln295_fu_136_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten41_fu_80 <= 11'd0;
        end
    end
end
...
always @ (*) begin
    if (((icmp_ln295_fu_130_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln295_1_fu_159_p2 = (wi_fu_76 + 8'd1);

assign add_ln295_fu_136_p2 = (ap_sig_allocacmp_indvar_flatten41_load + 11'd1);

assign add_ln296_fu_209_p2 = (select_ln295_fu_171_p3 + 4'd1);

assign add_ln298_fu_203_p2 = (zext_ln296_fu_199_p1 + tmp_1_fu_191_p3);
...
assign empty_fu_187_p1 = select_ln295_1_fu_179_p3[6:0];

assign icmp_ln295_fu_130_p2 = ((ap_sig_allocacmp_indvar_flatten41_load == 11'd1024) ? 1'b1 : 1'b0);

assign icmp_ln296_fu_165_p2 = ((ciw_fu_72 == 4'd8) ? 1'b1 : 1'b0);
...
assign select_ln295_1_fu_179_p3 = ((icmp_ln296_fu_165_p2[0:0] == 1'b1) ? add_ln295_1_fu_159_p2 : wi_fu_76);

assign select_ln295_fu_171_p3 = ((icmp_ln296_fu_165_p2[0:0] == 1'b1) ? 4'd0 : ciw_fu_72);

assign tmp_1_fu_191_p3 = {{empty_fu_187_p1}, {3'd0}};

assign x_buf_address0 = zext_ln298_fu_225_p1;
...
assign zext_ln296_fu_199_p1 = select_ln295_fu_171_p3;

assign zext_ln298_fu_225_p1 = add_ln298_reg_259;

endmodule //upconv_core_top_upconv_core_top_Pipeline_LOAD_ROW0_VITIS_LOOP_296_15
