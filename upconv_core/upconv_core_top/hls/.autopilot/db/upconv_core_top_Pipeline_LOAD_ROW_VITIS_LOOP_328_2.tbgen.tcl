set moduleName upconv_core_top_Pipeline_LOAD_ROW_VITIS_LOOP_328_2
set isTopModule 0
...
set cdfgNum 51
set C_modelName {upconv_core_top_Pipeline_LOAD_ROW_VITIS_LOOP_328_2}
...
set C_modelArgList {
	...
	{ empty int 5 regular  }
	{ mul_ln326 int 14 regular  }
	{ sext_ln325_1 int 59 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_in", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "X","offset": { "type": "dynamic","port_name": "X","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "mul_ln326", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln325_1", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ mul_ln326 sc_in sc_lv 14 signal 2 } 
	{ sext_ln325_1 sc_in sc_lv 59 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mul_ln326", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "mul_ln326", "role": "default" }} , 
 	{ "name": "sext_ln325_1", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "sext_ln325_1", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	mul_ln326 { ap_none {  { mul_ln326 in_data 0 14 } } }
	sext_ln325_1 { ap_none {  { sext_ln325_1 in_data 0 59 } } }
