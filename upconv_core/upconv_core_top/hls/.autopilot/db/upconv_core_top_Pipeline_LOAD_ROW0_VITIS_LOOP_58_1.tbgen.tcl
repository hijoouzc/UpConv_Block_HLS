set moduleName upconv_core_top_Pipeline_LOAD_ROW0_VITIS_LOOP_58_1
set isTopModule 0
...
set cdfgNum 17
set C_modelName {upconv_core_top_Pipeline_LOAD_ROW0_VITIS_LOOP_58_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_in", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "X","offset": { "type": "dynamic","port_name": "X","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "sext_ln56", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln56 sc_in sc_lv 59 signal 2 } 
	{ ci_words sc_in sc_lv 6 signal 3 } 
	{ ci_words_cast sc_in sc_lv 6 signal 4 } 
	{ x_buf_address0 sc_out sc_lv 11 signal 5 } 
	{ x_buf_ce0 sc_out sc_logic 1 signal 5 } 
	{ x_buf_we0 sc_out sc_logic 1 signal 5 } 
	{ x_buf_d0 sc_out sc_lv 256 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln56", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "sext_ln56", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_8ns_6ns_6ns_11_4_1_U1", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "133", "Max" : "7685"}
	, {"Name" : "Interval", "Min" : "133", "Max" : "7685"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln56 { ap_none {  { sext_ln56 in_data 0 59 } } }
