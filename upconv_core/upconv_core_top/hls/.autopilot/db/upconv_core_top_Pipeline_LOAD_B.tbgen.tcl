set moduleName upconv_core_top_Pipeline_LOAD_B
set isTopModule 0
...
set cdfgNum 14
set C_modelName {upconv_core_top_Pipeline_LOAD_B}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_param", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "B","offset": { "type": "dynamic","port_name": "B","bundle": "control"},"direction": "READONLY"},{"cName": "G","offset": { "type": "dynamic","port_name": "G","bundle": "control"},"direction": "READONLY"},{"cName": "BE","offset": { "type": "dynamic","port_name": "BE","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "sext_ln188", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln188 sc_in sc_lv 59 signal 2 } 
	{ b_buf_address0 sc_out sc_lv 5 signal 3 } 
	{ b_buf_ce0 sc_out sc_logic 1 signal 3 } 
	{ b_buf_we0 sc_out sc_logic 1 signal 3 } 
	{ b_buf_d0 sc_out sc_lv 256 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln188", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "sext_ln188", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln188 { ap_none {  { sext_ln188 in_data 0 59 } } }
