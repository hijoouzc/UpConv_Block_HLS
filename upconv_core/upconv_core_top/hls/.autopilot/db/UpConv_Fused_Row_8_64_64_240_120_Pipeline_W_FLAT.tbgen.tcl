set moduleName UpConv_Fused_Row_8_64_64_240_120_Pipeline_W_FLAT
set isTopModule 0
...
set cdfgNum 51
set C_modelName {UpConv_Fused_Row<8, 64, 64, 240, 120>_Pipeline_W_FLAT}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict w_local_7 { MEM_WIDTH 256 MEM_SIZE 4320 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict w_local_6 { MEM_WIDTH 256 MEM_SIZE 4320 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict w_local_5 { MEM_WIDTH 256 MEM_SIZE 4320 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict w_local_4 { MEM_WIDTH 256 MEM_SIZE 4320 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict w_local_3 { MEM_WIDTH 256 MEM_SIZE 4320 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict w_local_2 { MEM_WIDTH 256 MEM_SIZE 4320 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict w_local_1 { MEM_WIDTH 256 MEM_SIZE 4320 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict w_local { MEM_WIDTH 256 MEM_SIZE 4320 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ w_local_7 int 256 regular {array 135 { 0 3 } 0 1 }  }
	{ w_local_6 int 256 regular {array 135 { 0 3 } 0 1 }  }
	{ w_local_5 int 256 regular {array 135 { 0 3 } 0 1 }  }
	{ w_local_4 int 256 regular {array 135 { 0 3 } 0 1 }  }
	{ w_local_3 int 256 regular {array 135 { 0 3 } 0 1 }  }
	{ w_local_2 int 256 regular {array 135 { 0 3 } 0 1 }  }
	{ w_local_1 int 256 regular {array 135 { 0 3 } 0 1 }  }
	{ w_local int 256 regular {array 135 { 0 3 } 0 1 }  }
	{ p_cast17 int 11 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "w_local_7", "interface" : "memory", "bitwidth" : 256, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "p_cast17", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ m_axi_gmem_weight_0_AWVALID sc_out sc_logic 1 signal 10 } 
	{ m_axi_gmem_weight_0_AWREADY sc_in sc_logic 1 signal 10 } 
	{ m_axi_gmem_weight_0_AWADDR sc_out sc_lv 64 signal 10 } 
	{ m_axi_gmem_weight_0_AWID sc_out sc_lv 1 signal 10 } 
	{ m_axi_gmem_weight_0_AWLEN sc_out sc_lv 32 signal 10 } 
	{ m_axi_gmem_weight_0_AWSIZE sc_out sc_lv 3 signal 10 } 
	{ m_axi_gmem_weight_0_AWBURST sc_out sc_lv 2 signal 10 } 
	{ m_axi_gmem_weight_0_AWLOCK sc_out sc_lv 2 signal 10 } 
	{ m_axi_gmem_weight_0_AWCACHE sc_out sc_lv 4 signal 10 } 
	{ m_axi_gmem_weight_0_AWPROT sc_out sc_lv 3 signal 10 } 
	{ m_axi_gmem_weight_0_AWQOS sc_out sc_lv 4 signal 10 } 
	{ m_axi_gmem_weight_0_AWREGION sc_out sc_lv 4 signal 10 } 
	{ m_axi_gmem_weight_0_AWUSER sc_out sc_lv 1 signal 10 } 
	{ m_axi_gmem_weight_0_WVALID sc_out sc_logic 1 signal 10 } 
	{ m_axi_gmem_weight_0_WREADY sc_in sc_logic 1 signal 10 } 
	{ m_axi_gmem_weight_0_WDATA sc_out sc_lv 256 signal 10 } 
	{ m_axi_gmem_weight_0_WSTRB sc_out sc_lv 32 signal 10 } 
	{ m_axi_gmem_weight_0_WLAST sc_out sc_logic 1 signal 10 } 
	{ m_axi_gmem_weight_0_WID sc_out sc_lv 1 signal 10 } 
	{ m_axi_gmem_weight_0_WUSER sc_out sc_lv 1 signal 10 } 
	{ m_axi_gmem_weight_0_ARVALID sc_out sc_logic 1 signal 10 } 
	{ m_axi_gmem_weight_0_ARREADY sc_in sc_logic 1 signal 10 } 
	{ m_axi_gmem_weight_0_ARADDR sc_out sc_lv 64 signal 10 } 
	{ m_axi_gmem_weight_0_ARID sc_out sc_lv 1 signal 10 } 
	{ m_axi_gmem_weight_0_ARLEN sc_out sc_lv 32 signal 10 } 
	{ m_axi_gmem_weight_0_ARSIZE sc_out sc_lv 3 signal 10 } 
	{ m_axi_gmem_weight_0_ARBURST sc_out sc_lv 2 signal 10 } 
	{ m_axi_gmem_weight_0_ARLOCK sc_out sc_lv 2 signal 10 } 
	{ m_axi_gmem_weight_0_ARCACHE sc_out sc_lv 4 signal 10 } 
	{ m_axi_gmem_weight_0_ARPROT sc_out sc_lv 3 signal 10 } 
	{ m_axi_gmem_weight_0_ARQOS sc_out sc_lv 4 signal 10 } 
	{ m_axi_gmem_weight_0_ARREGION sc_out sc_lv 4 signal 10 } 
	{ m_axi_gmem_weight_0_ARUSER sc_out sc_lv 1 signal 10 } 
	{ m_axi_gmem_weight_0_RVALID sc_in sc_logic 1 signal 10 } 
	{ m_axi_gmem_weight_0_RREADY sc_out sc_logic 1 signal 10 } 
	{ m_axi_gmem_weight_0_RDATA sc_in sc_lv 256 signal 10 } 
	{ m_axi_gmem_weight_0_RLAST sc_in sc_logic 1 signal 10 } 
	{ m_axi_gmem_weight_0_RID sc_in sc_lv 1 signal 10 } 
	{ m_axi_gmem_weight_0_RFIFONUM sc_in sc_lv 11 signal 10 } 
	{ m_axi_gmem_weight_0_RUSER sc_in sc_lv 1 signal 10 } 
	{ m_axi_gmem_weight_0_RRESP sc_in sc_lv 2 signal 10 } 
	{ m_axi_gmem_weight_0_BVALID sc_in sc_logic 1 signal 10 } 
	{ m_axi_gmem_weight_0_BREADY sc_out sc_logic 1 signal 10 } 
	{ m_axi_gmem_weight_0_BRESP sc_in sc_lv 2 signal 10 } 
	{ m_axi_gmem_weight_0_BID sc_in sc_lv 1 signal 10 } 
	{ m_axi_gmem_weight_0_BUSER sc_in sc_lv 1 signal 10 } 
	{ w_local_7_address0 sc_out sc_lv 8 signal 0 } 
	{ w_local_7_ce0 sc_out sc_logic 1 signal 0 } 
	{ w_local_7_we0 sc_out sc_logic 1 signal 0 } 
	{ w_local_7_d0 sc_out sc_lv 256 signal 0 } 
	{ w_local_6_address0 sc_out sc_lv 8 signal 1 } 
	{ w_local_6_ce0 sc_out sc_logic 1 signal 1 } 
	{ w_local_6_we0 sc_out sc_logic 1 signal 1 } 
	{ w_local_6_d0 sc_out sc_lv 256 signal 1 } 
	{ w_local_5_address0 sc_out sc_lv 8 signal 2 } 
	{ w_local_5_ce0 sc_out sc_logic 1 signal 2 } 
	{ w_local_5_we0 sc_out sc_logic 1 signal 2 } 
	{ w_local_5_d0 sc_out sc_lv 256 signal 2 } 
	{ w_local_4_address0 sc_out sc_lv 8 signal 3 } 
	{ w_local_4_ce0 sc_out sc_logic 1 signal 3 } 
	{ w_local_4_we0 sc_out sc_logic 1 signal 3 } 
	{ w_local_4_d0 sc_out sc_lv 256 signal 3 } 
	{ w_local_3_address0 sc_out sc_lv 8 signal 4 } 
	{ w_local_3_ce0 sc_out sc_logic 1 signal 4 } 
	{ w_local_3_we0 sc_out sc_logic 1 signal 4 } 
	{ w_local_3_d0 sc_out sc_lv 256 signal 4 } 
	{ w_local_2_address0 sc_out sc_lv 8 signal 5 } 
	{ w_local_2_ce0 sc_out sc_logic 1 signal 5 } 
	{ w_local_2_we0 sc_out sc_logic 1 signal 5 } 
	{ w_local_2_d0 sc_out sc_lv 256 signal 5 } 
	{ w_local_1_address0 sc_out sc_lv 8 signal 6 } 
	{ w_local_1_ce0 sc_out sc_logic 1 signal 6 } 
	{ w_local_1_we0 sc_out sc_logic 1 signal 6 } 
	{ w_local_1_d0 sc_out sc_lv 256 signal 6 } 
	{ w_local_address0 sc_out sc_lv 8 signal 7 } 
	{ w_local_ce0 sc_out sc_logic 1 signal 7 } 
	{ w_local_we0 sc_out sc_logic 1 signal 7 } 
	{ w_local_d0 sc_out sc_lv 256 signal 7 } 
	{ p_cast17 sc_in sc_lv 11 signal 8 } 
	{ W_ptr sc_in sc_lv 64 signal 9 } 
	{ tc sc_in sc_lv 3 signal 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_cast17", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "p_cast17", "role": "default" }} , 
...
set Spec2ImplPortList { 
	w_local_7 { ap_memory {  { w_local_7_address0 mem_address 1 8 }  { w_local_7_ce0 mem_ce 1 1 }  { w_local_7_we0 mem_we 1 1 }  { w_local_7_d0 mem_din 1 256 } } }
	w_local_6 { ap_memory {  { w_local_6_address0 mem_address 1 8 }  { w_local_6_ce0 mem_ce 1 1 }  { w_local_6_we0 mem_we 1 1 }  { w_local_6_d0 mem_din 1 256 } } }
	w_local_5 { ap_memory {  { w_local_5_address0 mem_address 1 8 }  { w_local_5_ce0 mem_ce 1 1 }  { w_local_5_we0 mem_we 1 1 }  { w_local_5_d0 mem_din 1 256 } } }
	w_local_4 { ap_memory {  { w_local_4_address0 mem_address 1 8 }  { w_local_4_ce0 mem_ce 1 1 }  { w_local_4_we0 mem_we 1 1 }  { w_local_4_d0 mem_din 1 256 } } }
	w_local_3 { ap_memory {  { w_local_3_address0 mem_address 1 8 }  { w_local_3_ce0 mem_ce 1 1 }  { w_local_3_we0 mem_we 1 1 }  { w_local_3_d0 mem_din 1 256 } } }
	w_local_2 { ap_memory {  { w_local_2_address0 mem_address 1 8 }  { w_local_2_ce0 mem_ce 1 1 }  { w_local_2_we0 mem_we 1 1 }  { w_local_2_d0 mem_din 1 256 } } }
	w_local_1 { ap_memory {  { w_local_1_address0 mem_address 1 8 }  { w_local_1_ce0 mem_ce 1 1 }  { w_local_1_we0 mem_we 1 1 }  { w_local_1_d0 mem_din 1 256 } } }
	w_local { ap_memory {  { w_local_address0 mem_address 1 8 }  { w_local_ce0 mem_ce 1 1 }  { w_local_we0 mem_we 1 1 }  { w_local_d0 mem_din 1 256 } } }
	p_cast17 { ap_none {  { p_cast17 in_data 0 11 } } }
