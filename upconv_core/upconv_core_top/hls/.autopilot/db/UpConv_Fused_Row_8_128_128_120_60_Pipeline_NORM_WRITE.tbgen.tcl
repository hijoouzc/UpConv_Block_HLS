set moduleName UpConv_Fused_Row_8_128_128_120_60_Pipeline_NORM_WRITE
set isTopModule 0
...
set cdfgNum 49
set C_modelName {UpConv_Fused_Row<8, 128, 128, 120, 60>_Pipeline_NORM_WRITE}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_out", "interface" : "axi_master", "bitwidth" : 256, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "Y","offset": { "type": "dynamic","port_name": "Y","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "conv2", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv2", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "conv2", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	conv2 { ap_none {  { conv2 in_data 0 16 } } }
