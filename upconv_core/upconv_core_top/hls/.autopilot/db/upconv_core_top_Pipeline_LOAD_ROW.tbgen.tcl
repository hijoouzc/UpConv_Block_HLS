set moduleName upconv_core_top_Pipeline_LOAD_ROW
set isTopModule 0
...
set cdfgNum 14
set C_modelName {upconv_core_top_Pipeline_LOAD_ROW}
...
set C_modelArgList {
	...
	{ shl_ln1 int 25 regular  }
	{ base_buf int 11 regular  }
	{ sext_ln397 int 59 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_in", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "X","offset": { "type": "dynamic","port_name": "X","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "shl_ln1", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "base_buf", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln397", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ shl_ln1 sc_in sc_lv 25 signal 2 } 
	{ base_buf sc_in sc_lv 11 signal 3 } 
	{ sext_ln397 sc_in sc_lv 59 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "shl_ln1", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "shl_ln1", "role": "default" }} , 
 	{ "name": "base_buf", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "base_buf", "role": "default" }} , 
 	{ "name": "sext_ln397", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "sext_ln397", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "76", "Max" : "2060"}
	, {"Name" : "Interval", "Min" : "76", "Max" : "2060"}
]}
...
set Spec2ImplPortList { 
	...
	shl_ln1 { ap_none {  { shl_ln1 in_data 0 25 } } }
	base_buf { ap_none {  { base_buf in_data 0 11 } } }
	sext_ln397 { ap_none {  { sext_ln397 in_data 0 59 } } }
