...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename mean_buf_1 \
    op interface \
    ports { mean_buf_1_address1 { O 6 vector } mean_buf_1_ce1 { O 1 bit } mean_buf_1_we1 { O 1 bit } mean_buf_1_d1 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'mean_buf_1'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename inv_buf_1 \
    op interface \
    ports { inv_buf_1_address1 { O 6 vector } inv_buf_1_ce1 { O 1 bit } inv_buf_1_we1 { O 1 bit } inv_buf_1_d1 { O 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'inv_buf_1'"
}
}
