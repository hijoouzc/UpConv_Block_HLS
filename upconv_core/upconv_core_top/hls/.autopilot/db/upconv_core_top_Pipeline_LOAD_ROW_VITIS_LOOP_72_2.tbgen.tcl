set moduleName upconv_core_top_Pipeline_LOAD_ROW_VITIS_LOOP_72_2
set isTopModule 0
...
set cdfgNum 17
set C_modelName {upconv_core_top_Pipeline_LOAD_ROW_VITIS_LOOP_72_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict x_buf { MEM_WIDTH 256 MEM_SIZE 65536 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem_in int 256 regular {axi_master 0}  }
	{ mul_ln56 int 13 regular  }
	{ sext_ln70 int 59 regular  }
	{ ci_words int 6 regular  }
	{ mul50 int 8 regular  }
	{ ci_words_cast int 6 regular  }
	{ x_buf int 256 regular {array 2048 { 0 3 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_in", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "X","offset": { "type": "dynamic","port_name": "X","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "mul_ln56", "interface" : "wire", "bitwidth" : 13, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln70", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
 	{ "Name" : "ci_words", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "mul50", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "ci_words_cast", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "x_buf", "interface" : "memory", "bitwidth" : 256, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ m_axi_gmem_in_0_WDATA sc_out sc_lv 256 signal 0 } 
	{ m_axi_gmem_in_0_WSTRB sc_out sc_lv 32 signal 0 } 
	...
	{ m_axi_gmem_in_0_RDATA sc_in sc_lv 256 signal 0 } 
	...
	{ mul_ln56 sc_in sc_lv 13 signal 1 } 
	{ sext_ln70 sc_in sc_lv 59 signal 2 } 
	{ ci_words sc_in sc_lv 6 signal 3 } 
	{ mul50 sc_in sc_lv 8 signal 4 } 
	{ ci_words_cast sc_in sc_lv 6 signal 5 } 
	{ x_buf_address0 sc_out sc_lv 11 signal 6 } 
	{ x_buf_ce0 sc_out sc_logic 1 signal 6 } 
	{ x_buf_we0 sc_out sc_logic 1 signal 6 } 
	{ x_buf_d0 sc_out sc_lv 256 signal 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "m_axi_gmem_in_0_WDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "gmem_in", "role": "0_WDATA" }} , 
 	{ "name": "m_axi_gmem_in_0_WSTRB", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "gmem_in", "role": "0_WSTRB" }} , 
 	...
 	{ "name": "m_axi_gmem_in_0_RDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "gmem_in", "role": "0_RDATA" }} , 
 	...
 	{ "name": "mul_ln56", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "mul_ln56", "role": "default" }} , 
 	{ "name": "sext_ln70", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "sext_ln70", "role": "default" }} , 
 	{ "name": "ci_words", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "ci_words", "role": "default" }} , 
 	{ "name": "mul50", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "mul50", "role": "default" }} , 
 	{ "name": "ci_words_cast", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "ci_words_cast", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ama_addmuladd_8ns_8ns_6ns_6ns_11_4_1_U719", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "134", "Max" : "7686"}
	, {"Name" : "Interval", "Min" : "134", "Max" : "7686"}
]}
