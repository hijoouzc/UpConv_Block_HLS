...
entity upconv_core_top_fifo_w10_d2_S is 
    generic (
...
architecture rtl of upconv_core_top_fifo_w10_d2_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component upconv_core_top_fifo_w10_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 10;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_upconv_core_top_fifo_w10_d2_S_ShiftReg : upconv_core_top_fifo_w10_d2_S_ShiftReg
    generic map (
...
entity upconv_core_top_fifo_w10_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 10;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end upconv_core_top_fifo_w10_d2_S_ShiftReg;

architecture rtl of upconv_core_top_fifo_w10_d2_S_ShiftReg is
