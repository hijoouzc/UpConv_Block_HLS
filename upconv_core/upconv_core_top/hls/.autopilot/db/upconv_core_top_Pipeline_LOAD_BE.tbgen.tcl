set moduleName upconv_core_top_Pipeline_LOAD_BE
set isTopModule 0
...
set cdfgNum 14
set C_modelName {upconv_core_top_Pipeline_LOAD_BE}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_param", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "B","offset": { "type": "dynamic","port_name": "B","bundle": "control"},"direction": "READONLY"},{"cName": "G","offset": { "type": "dynamic","port_name": "G","bundle": "control"},"direction": "READONLY"},{"cName": "BE","offset": { "type": "dynamic","port_name": "BE","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "sext_ln198", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ m_axi_gmem_param_0_AWVALID sc_out sc_logic 1 signal 0 } 
	{ m_axi_gmem_param_0_AWREADY sc_in sc_logic 1 signal 0 } 
	{ m_axi_gmem_param_0_AWADDR sc_out sc_lv 64 signal 0 } 
	{ m_axi_gmem_param_0_AWID sc_out sc_lv 1 signal 0 } 
	{ m_axi_gmem_param_0_AWLEN sc_out sc_lv 32 signal 0 } 
	{ m_axi_gmem_param_0_AWSIZE sc_out sc_lv 3 signal 0 } 
	{ m_axi_gmem_param_0_AWBURST sc_out sc_lv 2 signal 0 } 
	{ m_axi_gmem_param_0_AWLOCK sc_out sc_lv 2 signal 0 } 
	{ m_axi_gmem_param_0_AWCACHE sc_out sc_lv 4 signal 0 } 
	{ m_axi_gmem_param_0_AWPROT sc_out sc_lv 3 signal 0 } 
	{ m_axi_gmem_param_0_AWQOS sc_out sc_lv 4 signal 0 } 
	{ m_axi_gmem_param_0_AWREGION sc_out sc_lv 4 signal 0 } 
	{ m_axi_gmem_param_0_AWUSER sc_out sc_lv 1 signal 0 } 
	{ m_axi_gmem_param_0_WVALID sc_out sc_logic 1 signal 0 } 
	{ m_axi_gmem_param_0_WREADY sc_in sc_logic 1 signal 0 } 
	{ m_axi_gmem_param_0_WDATA sc_out sc_lv 256 signal 0 } 
	{ m_axi_gmem_param_0_WSTRB sc_out sc_lv 32 signal 0 } 
	{ m_axi_gmem_param_0_WLAST sc_out sc_logic 1 signal 0 } 
	{ m_axi_gmem_param_0_WID sc_out sc_lv 1 signal 0 } 
	{ m_axi_gmem_param_0_WUSER sc_out sc_lv 1 signal 0 } 
	{ m_axi_gmem_param_0_ARVALID sc_out sc_logic 1 signal 0 } 
	{ m_axi_gmem_param_0_ARREADY sc_in sc_logic 1 signal 0 } 
	{ m_axi_gmem_param_0_ARADDR sc_out sc_lv 64 signal 0 } 
	{ m_axi_gmem_param_0_ARID sc_out sc_lv 1 signal 0 } 
	{ m_axi_gmem_param_0_ARLEN sc_out sc_lv 32 signal 0 } 
	{ m_axi_gmem_param_0_ARSIZE sc_out sc_lv 3 signal 0 } 
	{ m_axi_gmem_param_0_ARBURST sc_out sc_lv 2 signal 0 } 
	{ m_axi_gmem_param_0_ARLOCK sc_out sc_lv 2 signal 0 } 
	{ m_axi_gmem_param_0_ARCACHE sc_out sc_lv 4 signal 0 } 
	{ m_axi_gmem_param_0_ARPROT sc_out sc_lv 3 signal 0 } 
	{ m_axi_gmem_param_0_ARQOS sc_out sc_lv 4 signal 0 } 
	{ m_axi_gmem_param_0_ARREGION sc_out sc_lv 4 signal 0 } 
	{ m_axi_gmem_param_0_ARUSER sc_out sc_lv 1 signal 0 } 
	{ m_axi_gmem_param_0_RVALID sc_in sc_logic 1 signal 0 } 
	{ m_axi_gmem_param_0_RREADY sc_out sc_logic 1 signal 0 } 
	{ m_axi_gmem_param_0_RDATA sc_in sc_lv 256 signal 0 } 
	{ m_axi_gmem_param_0_RLAST sc_in sc_logic 1 signal 0 } 
	{ m_axi_gmem_param_0_RID sc_in sc_lv 1 signal 0 } 
	{ m_axi_gmem_param_0_RFIFONUM sc_in sc_lv 11 signal 0 } 
	{ m_axi_gmem_param_0_RUSER sc_in sc_lv 1 signal 0 } 
	{ m_axi_gmem_param_0_RRESP sc_in sc_lv 2 signal 0 } 
	{ m_axi_gmem_param_0_BVALID sc_in sc_logic 1 signal 0 } 
	{ m_axi_gmem_param_0_BREADY sc_out sc_logic 1 signal 0 } 
	{ m_axi_gmem_param_0_BRESP sc_in sc_lv 2 signal 0 } 
	{ m_axi_gmem_param_0_BID sc_in sc_lv 1 signal 0 } 
	{ m_axi_gmem_param_0_BUSER sc_in sc_lv 1 signal 0 } 
	{ C_WORDS_OUT sc_in sc_lv 5 signal 1 } 
	{ sext_ln198 sc_in sc_lv 59 signal 2 } 
	{ be_buf_address0 sc_out sc_lv 5 signal 3 } 
	{ be_buf_ce0 sc_out sc_logic 1 signal 3 } 
	{ be_buf_we0 sc_out sc_logic 1 signal 3 } 
	{ be_buf_d0 sc_out sc_lv 256 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln198", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "sext_ln198", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "7", "Max" : "33"}
	, {"Name" : "Interval", "Min" : "7", "Max" : "33"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln198 { ap_none {  { sext_ln198 in_data 0 59 } } }
