set moduleName UpConv_Fused_Row_8_64_64_240_120_Pipeline_VITIS_LOOP_142_2_VITIS_LOOP_143_3
set isTopModule 0
...
set cdfgNum 49
set C_modelName {UpConv_Fused_Row<8, 64, 64, 240, 120>_Pipeline_VITIS_LOOP_142_2_VITIS_LOOP_143_3}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_weight", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "W","offset": { "type": "dynamic","port_name": "W","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln142", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln142", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "sext_ln142", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln142 { ap_none {  { sext_ln142 in_data 0 59 } } }
