...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename mean_buf_2 \
    op interface \
    ports { mean_buf_2_address1 { O 5 vector } mean_buf_2_ce1 { O 1 bit } mean_buf_2_we1 { O 1 bit } mean_buf_2_d1 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename inv_buf_2 \
    op interface \
    ports { inv_buf_2_address1 { O 5 vector } inv_buf_2_ce1 { O 1 bit } inv_buf_2_we1 { O 1 bit } inv_buf_2_d1 { O 16 vector } } \
} "
} else {
