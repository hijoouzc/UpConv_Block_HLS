set moduleName upconv_core_top_Pipeline_LOAD_ROW_VITIS_LOOP_328_26
set isTopModule 0
...
set cdfgNum 51
set C_modelName {upconv_core_top_Pipeline_LOAD_ROW_VITIS_LOOP_328_26}
...
set C_modelArgList {
	...
	{ empty int 1 regular  }
	{ indvar171 int 7 regular  }
	{ sext_ln325_4 int 59 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_in", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "X","offset": { "type": "dynamic","port_name": "X","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "indvar171", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln325_4", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ indvar171 sc_in sc_lv 7 signal 2 } 
	{ sext_ln325_4 sc_in sc_lv 59 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "indvar171", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "indvar171", "role": "default" }} , 
 	{ "name": "sext_ln325_4", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "sext_ln325_4", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	indvar171 { ap_none {  { indvar171 in_data 0 7 } } }
	sext_ln325_4 { ap_none {  { sext_ln325_4 in_data 0 59 } } }
