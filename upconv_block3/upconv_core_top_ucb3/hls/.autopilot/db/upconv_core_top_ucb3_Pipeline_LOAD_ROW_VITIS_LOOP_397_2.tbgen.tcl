set moduleName upconv_core_top_ucb3_Pipeline_LOAD_ROW_VITIS_LOOP_397_2
set isTopModule 0
...
set cdfgNum 15
set C_modelName {upconv_core_top_ucb3_Pipeline_LOAD_ROW_VITIS_LOOP_397_2}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_in", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "X","offset": { "type": "dynamic","port_name": "X","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "indvar", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "indvar", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "indvar", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	indvar { ap_none {  { indvar in_data 0 7 } } }
