...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler upconv_core_top_ucb2_partselect_16ns_256ns_32s_16_1_1 BINDTYPE {op} TYPE {partselect} IMPL {auto}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler upconv_core_top_ucb2_sparsemux_33_4_16_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {compactencoding_dontcare}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler upconv_core_top_ucb2_sparsemux_17_3_32_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {compactencoding_dontcare}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename b_buf \
    op interface \
    ports { b_buf_address0 { O 3 vector } b_buf_ce0 { O 1 bit } b_buf_q0 { I 256 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename mean_buf \
    op interface \
    ports { mean_buf_address1 { O 7 vector } mean_buf_ce1 { O 1 bit } mean_buf_we1 { O 1 bit } mean_buf_d1 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename inv_buf \
    op interface \
    ports { inv_buf_address1 { O 7 vector } inv_buf_ce1 { O 1 bit } inv_buf_we1 { O 1 bit } inv_buf_d1 { O 16 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_conv42_i \
    op interface \
    ports { conv42_i { I 32 vector } } \
} "
}
