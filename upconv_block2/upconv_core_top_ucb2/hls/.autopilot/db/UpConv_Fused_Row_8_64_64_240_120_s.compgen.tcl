...
set name upconv_core_top_ucb2_hptosp_16ns_32_2_no_dsp_1
...
set name upconv_core_top_ucb2_sptohp_32ns_16_2_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler upconv_core_top_ucb2_UpConv_Fused_Row_8_64_64_240_120_s_void_UpConv_Fused_Row_ap_uint_ap_uint_consbkb BINDTYPE {storage} TYPE {ram_t2p} IMPL {uram} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler upconv_core_top_ucb2_UpConv_Fused_Row_8_64_64_240_120_s_mean_buf_RAM_2P_LUTRAM_1R1W BINDTYPE {storage} TYPE {ram_2p} IMPL {lutram} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler upconv_core_top_ucb2_UpConv_Fused_Row_8_64_64_240_120_s_inv_buf_RAM_2P_LUTRAM_1R1W BINDTYPE {storage} TYPE {ram_2p} IMPL {lutram} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler upconv_core_top_ucb2_UpConv_Fused_Row_8_64_64_240_120_s_b_buf_RAM_T2P_BRAM_1R1W BINDTYPE {storage} TYPE {ram_t2p} IMPL {bram} LATENCY 2 ALLOW_PRAGMA 1
}
