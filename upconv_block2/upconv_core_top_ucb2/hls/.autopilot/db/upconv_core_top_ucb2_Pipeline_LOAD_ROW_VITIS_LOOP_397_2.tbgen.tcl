set moduleName upconv_core_top_ucb2_Pipeline_LOAD_ROW_VITIS_LOOP_397_2
set isTopModule 0
...
set cdfgNum 15
set C_modelName {upconv_core_top_ucb2_Pipeline_LOAD_ROW_VITIS_LOOP_397_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict x_buf { MEM_WIDTH 256 MEM_SIZE 61440 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem_in int 256 regular {axi_master 0}  }
	{ empty int 7 regular  }
	{ mul_ln395 int 16 regular  }
	{ sext_ln394 int 59 regular  }
	{ x_buf int 256 regular {array 1920 { 0 3 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_in", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "X","offset": { "type": "dynamic","port_name": "X","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "mul_ln395", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln394", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ mul_ln395 sc_in sc_lv 16 signal 2 } 
	{ sext_ln394 sc_in sc_lv 59 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mul_ln395", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "mul_ln395", "role": "default" }} , 
 	{ "name": "sext_ln394", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "sext_ln394", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "973", "Max" : "973"}
	, {"Name" : "Interval", "Min" : "973", "Max" : "973"}
]}
...
set Spec2ImplPortList { 
	...
	mul_ln395 { ap_none {  { mul_ln395 in_data 0 16 } } }
	sext_ln394 { ap_none {  { sext_ln394 in_data 0 59 } } }
